...
import {
  ...
  Minus, Equal, MapPin, Link2, Pencil, ArrowRight, ChevronDown, NotebookPen, CornerDownRight
} from "lucide-react";
...
export default function App() {
  ...
  const [lists, setLists] = useState([{ id: "tasks", name: "Tasks", emoji: "🏠" }]);
  ...
  // Reflection
  const [reflection, setReflection] = useState({ text: "", mood: null });
  ...
  return (
    <div className="flex h-full min-h-[720px] w-full bg-slate-950 text-slate-200" style={{ fontFamily: "Inter, ui-sans-serif, system-ui" }}>
      ...
      `}</style>
      <Sidebar ctx={ctx} />
      <div className={cn("flex-1", view === "tasks" || view === "goals" ? "overflow-hidden" : "overflow-y-auto")}>
...
function Sidebar({ ctx }) {
  ...
  return (
    <aside className="flex w-56 flex-shrink-0 flex-col border-r border-slate-800 bg-slate-950 px-3 py-4">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <NavItem icon={Bell} label="Notifications" active={view === "notifications"} onClick={() => setView("notifications")} badge={unreadCount || null} />
      </div>

      <div className="mb-1 mt-5 px-2 text-[11px] font-semibold tracking-wider text-slate-600">TRACK</div>
      <div className="flex flex-col gap-0.5">
        <NavItem icon={RefreshCw} label="Habits" active={view === "habits"} onClick={() => setView("habits")} />
        <NavItem icon={ClipboardList} label="Tasks" active={view === "tasks"} onClick={() => setView("tasks")} />
        <NavItem icon={Clock} label="Focus Session" active={view === "focus"} onClick={() => setView("focus")} />
        <NavItem icon={ListChecks} label="Habit Scorecard" active={view === "habitScorecard"} onClick={() => setView("habitScorecard")} />
      ...
      <div className="flex flex-col gap-0.5">
        <NavItem icon={Target} label="Goals" active={view === "goals"} onClick={() => setView("goals")} />
